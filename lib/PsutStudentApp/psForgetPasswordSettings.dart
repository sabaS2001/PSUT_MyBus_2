...
class PSForgetSettings extends StatefulWidget {
  const PSForgetSettings({super.key});

  @override
  State<PSForgetSettings> createState() => _PSForgetSettingsState();
}

class _PSForgetSettingsState extends State<PSForgetSettings> {
