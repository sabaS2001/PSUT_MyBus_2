...
class PSProfile extends StatelessWidget with InputValidationPSProfileMixin{
   PSProfile({super.key});
                    ...
                    child: ElevatedButton(
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {
                            Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const PSSettings()));
                          }
                        },
